...
throwError = function(message) {
  ...
  if (typeof message === 'string' || message instanceof String) {
    ...
    if (isObject(exceptionDetails) && (typeof logLevel === 'string' || logLevel instanceof String)) {
...
handleError = function(error) {
  ...
  if (isObject(payloadData) && (typeof logLevel === 'string' || logLevel instanceof String)) {
